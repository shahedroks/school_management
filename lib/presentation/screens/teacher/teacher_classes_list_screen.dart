...
class TeacherClassesListScreen extends StatefulWidget {
  ...
  @override
  State<TeacherClassesListScreen> createState() => _TeacherClassesListScreenState();
}
...
class _TeacherClassesListScreenState extends State<TeacherClassesListScreen> {
      ...
      child: Row(
        children: [
          Expanded(
            child: Column(
              ...
              children: [
                ...
                Text(
                  count == 1 ? '1 ${lang.t('classes.assignedToYou')}' : '$count ${lang.t('classes.assignedToYouPlural')}',
          ...
          IconButton(
            ...
            icon: Icon(_showFilters ? Icons.tune : Icons.tune_outlined, color: Colors.white, size: 24),
  ...
  Widget _buildFiltersPanel(BuildContext context, LanguageProvider lang, List<String> grades, bool hasActiveFilters) {
    return Card(
      elevation: 1,
        ...
        child: Column(
          ...
          children: [
            if (hasActiveFilters)
              Align(
                ...
                child: TextButton(
                  ...
                  child: Text(lang.t('classes.resetAll'), style: const TextStyle(color: AppTheme.primary, fontSize: 12)),
                ),
              ),
            const SizedBox(height: 4),
            Row(
              children: [
                ...
                Text(lang.t('classes.grade'), style: Theme.of(context).textTheme.labelMedium?.copyWith(fontWeight: FontWeight.w500)),
              ],
            ),
            ...
            DropdownButtonFormField<String>(
              ...
              items: [
                DropdownMenuItem(value: 'all', child: Text(lang.t('classes.allGrades'))),
                ...grades.map((g) => DropdownMenuItem(value: g, child: Text(g))),
              ],
  ...
  Widget _buildResultsCount(BuildContext context, LanguageProvider lang, int count) {
    final text = count == 0
  ...
  Widget _buildEmptyState(BuildContext context, LanguageProvider lang, bool hasActiveFilters) {
    return Card(
      elevation: 1,
      shape: RoundedRectangleBorder(
        borderRadius: BorderRadius.circular(12),
      ...
      child: Padding(
        ...
        child: Column(
          children: [
            ...
            const SizedBox(height: 12),
            Text(lang.t('classes.noClassesMatchFilters'), style: TextStyle(fontSize: 14, color: Colors.grey.shade600), textAlign: TextAlign.center),
            if (hasActiveFilters) ...[
              const SizedBox(height: 12),
              OutlinedButton(
                onPressed: () => setState(() => _gradeFilter = 'all'),
  ...
  Widget _buildClassesList(BuildContext context, LanguageProvider lang, List<ClassEntity> classes) {
    return Column(
                ...
                child: Column(
                  ...
                  children: [
                    Row(
                      children: [
                        Expanded(
                          child: Text(c.subject, style: Theme.of(context).textTheme.titleMedium?.copyWith(fontWeight: FontWeight.bold)),
                        ),
                        Container(
                          ...
                          child: Text(c.level, style: const TextStyle(fontSize: 12, fontWeight: FontWeight.w500, color: AppTheme.accent)),
                        ),
                      ],
                    ),
                    const SizedBox(height: 12),
                    Row(
                      children: [
                        ...
                        const SizedBox(width: 8),
                        Expanded(child: Text(c.schedule, style: TextStyle(fontSize: 14, color: Colors.grey.shade600))),
                      ],
                    ),
                    const SizedBox(height: 8),
                    Row(
                      children: [
                        ...
                        Text.rich(
                          TextSpan(
                            ...
                            children: [
                              TextSpan(text: '${c.students} ', style: TextStyle(fontWeight: FontWeight.w600, color: Theme.of(context).textTheme.bodyMedium?.color)),
                              TextSpan(text: lang.t('classes.studentsEnrolled')),
                            ],
                          ),
                        ),
                      ],
