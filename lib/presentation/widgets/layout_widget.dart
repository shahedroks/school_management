  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      children: [
                  ...
                  if (canGoBack)
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        Text('Nouadhibou HS', style: Theme.of(context).textTheme.titleSmall?.copyWith(fontWeight: FontWeight.bold)),
                      ],
                    ),
                  const Spacer(),
                  IconButton(
        ...
        Expanded(child: SingleChildScrollView(child: Padding(padding: const EdgeInsets.all(16), child: child))),
        Material(
          color: Colors.white,
          elevation: 8,
          child: SafeArea(
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(item.label, style: TextStyle(fontSize: 10, color: isActive ? AppTheme.primary : Colors.grey)),
                      ],
                    ),
                  ),
                );
